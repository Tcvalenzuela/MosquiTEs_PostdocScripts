...
OUT="/beegfs/project/mosquites/aalbo1200g/TEMP2Loops/CombineLibrary/Awka"
CPUS=10
...
for file in $Fastq/MoreSamples/Awka/*_1.fq.gz 
do  sname=$(basename "$file"| sed 's*_NoDup_1_val_1.fq.gz**g')

R1=$Fastq/MoreSamples/Awka/"$sname"_NoDup_1_val_1.fq.gz
R2=$Fastq/MoreSamples/Awka/"$sname"_NoDup_2_val_2.fq.gz
if [[ -e "$OUT/$sname/$R1.insertion.bed" ]]; then
        continue
    fi
