...
OUT="/beegfs/project/mosquites/aalbo1200g/TEMP2Loops/CombineLibrary/Beijing"
CPUS=10
...
for file in $Fastq/Beijing/*_1.fq.gz
do  sname=$(basename "$file"| sed 's*_NoDup_1_val_1.fq.gz**g')

R1=$Fastq/Beijing/"$sname"_NoDup_1_val_1.fq.gz
R2=$Fastq/Beijing/"$sname"_NoDup_2_val_2.fq.gz
